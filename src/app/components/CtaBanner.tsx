        ...
        <div className='relative justify-center flex px-[2%] py-20 md:py-0'>
            <div className='md:absolute bottom-[-90px] shadow-2xl md:flex max-w-[900px] w-[95%] bg-white rounded-md p-4' data-aos="fade-up">
                ...
                <div className='flex flex-col space-y-5 mt-5'>
                    ...
                    <button  onClick={(e)=>downloadPdf(e, cv.link)} className='bg-gray-200 text-black py-2 px-3 flex items-center'><MdDownloadForOffline className='text-[#333] text-md md:text-lg mr-2'/> {cv.text.split(' ')[0]}</button>
                </div>
            </div>
        </div>
    )
